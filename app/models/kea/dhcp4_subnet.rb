module Kea
  class Dhcp4Subnet < KeaRecord
    ...
    has_many :dhcp4_pools, foreign_key: "subnet_id", inverse_of: :dhcp4_subnet, dependent: :destroy
    ...
    has_many :lease4s, foreign_key: "subnet_id", inverse_of: :dhcp4_subnet, dependent: :nullify
    has_many :lease4_stats, foreign_key: "subnet_id", inverse_of: :dhcp4_subnet, dependent: :delete_all
