module Kea
  class Dhcp6Subnet < KeaRecord
    ...
    has_many :dhcp6_pools, foreign_key: "subnet_id", inverse_of: :dhcp6_subnet, dependent: :destroy
    ...
    has_many :lease6s, foreign_key: "subnet_id", inverse_of: :dhcp6_subnet, dependent: :nullify
    has_many :lease6_stats, foreign_key: "subnet_id", inverse_of: :dhcp6_subnet, dependent: :delete_all
